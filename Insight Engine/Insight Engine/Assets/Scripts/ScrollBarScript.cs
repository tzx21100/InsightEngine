/*!
 * \file ScrollBarScript.cs
 * \author Matthew Ng, matthewdeen.ng@digipen.edu 
 * \par Course: CSD2451
 * \brief
 * This C# file contains the ScrollBarScript class, used for the ScrollBar in settings page.
 *
 * \copyright
...
namespace IS
{
    class ScrollBarScript
    {
        ...
        static public void Update()
        {
            ...
            y_pos = origin.y + (0.453f * win_dimension.y);
