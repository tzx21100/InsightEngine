...
namespace IS
{
    class MainMenuScript
    {
        ...
        static public void Init()
        {
            ...
            //team_logo_entity = InternalCalls.CreateEntityButtonNoText("Team Logo", team_logo_image, "TeamLogoScript");
            //InternalCalls.AttachLightComponentToEntity(team_logo_entity, 0, 0, 0, 0, 0);//for gimick
