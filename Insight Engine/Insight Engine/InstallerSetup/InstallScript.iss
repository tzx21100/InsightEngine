...
DefaultDirName={pf}\DigiPen\Fragments

; Start menu directory
DefaultGroupName=DigiPen\Fragments

; Output directory for the installer.
OutputDir=.\INSTALLER

; Setup executable installer
OutputBaseFilename=Fragments_Setup
...
[Icons]
Name: {group}\Fragments; Filename: {app}\Fragments.exe; WorkingDir: {app}; IconFilename: "{app}\Icon.ico"
Name: {group}\{cm:UninstallProgram,Fragments}; Filename: {uninstallexe}
Name: {group}\{cm:UninstallProgram,Fragments}; Filename: {uninstallexe};  IconFilename: "{app}\Icon.ico"
Name: {commondesktop}\Fragments; Filename: {app}\Fragments.exe; Tasks: desktopicon; WorkingDir: {app}; IconFilename: "{app}\Icon.ico"
...
Filename: {app}\Fragments.exe; Description: {cm:LaunchProgram,Fragments}; Flags: nowait postinstall skipifsilent


;To be able to run and generate the Fragments_Setup.exe you need to download and install "Inno Setup" application, then open this file with the application.