#ifndef GAM200_INSIGHT_ENGINE_WINDOW_UTILS_WINDOW_UTILS_H
#define GAM200_INSIGHT_ENGINE_WINDOW_UTILS_WINDOW_UTILS_H
...
namespace IS {
    ...
    namespace WindowUtils {
         ...
         * \brief Open a script.
         *
         * \return filepath to the script.
         */
        void OpenScript();

        std::string ChangeScript();

    } // end namespace WindowUtils

} // end namespace IS

#endif // !GAM200_INSIGHT_ENGINE_WINDOW_UTILS_WINDOW_UTILS_H
